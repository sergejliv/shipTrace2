...
var (
	ErrCantChangeAddress = fmt.Errorf("cannot change address: parcel is not in registered status")
	ErrCantDelete        = fmt.Errorf("cannot delete parcel: parcel is not in registered status")
)
